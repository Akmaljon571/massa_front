    ...
    return (
        <footer className="footer">
            ...
            <ul className="footer_bottom">
                <li>
                    <div className="left">
                        <p className='top'>All or Nothing</p>
                        <a href="tel:+998901234567">+ 94 099 4001</a>
                        <a href="tel:+998901234567">+ 94 099 4001</a>
                    </div>
                    <div className="right">
                        <a href="/">About me</a>
                ...
                <li className='aloqa-uchun'>
                    <div className="aloqa">
                        <div className="aloqa_top">
                            <img src={mail} alt="mail" />
                            <p>allornothing.uz@gmail.com</p>
                        </div>
                        <div className="aloqa_bottom">
                            <img src={location} alt="location" />
                            <p>T.sh Moirobod tuman. Fidokor 10. 4a uy </p>
                        </div>
                    </div>
                        <hr />
                    <div className="link">
                        <a href="/insta" className="insta">
            ...
            <div className="footer_after">
                <p>
                    Designer by: <span>Og’abek Yusuf</span>
                </p>
                <p>
                    Developer: <span>Akmaljondev</span>
                </p>
                <p className='media_none'>
                    Getter.com  <span>December - 2023 year</span>
                </p>
            </div>
        </footer>
    )
